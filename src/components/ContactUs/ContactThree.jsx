    ...
    <div className="bg-[#F5F7FE] py-8 px-4 md:px-12 font-[Quicksand]">
      ...
      <div className="hidden md:flex max-w-[1400px] mx-auto w-full flex-row justify-between items-start gap-8 px-6 xl:px-12">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-3xl xl:text-4xl font-bold text-[#0A1F8F]">
            Contact Us
          </h3>
            ...
            {[
              ...
              <div key={idx} className="flex items-start gap-4">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-sm lg:text-base font-semibold text-[#0A1F8F] break-words">
                    {value}
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-6 flex-shrink-0">
          ...
          <div className="flex gap-4">
            {[FaFacebookF, BsTwitterX, Instagram].map((Icon, index) => (
              <div
                key={index}
                className="w-[clamp(3.5rem,4vw,4.5rem)] h-[clamp(3.5rem,4vw,4.5rem)] bg-[#0A1F8F] rounded-[13px] flex justify-center items-center text-white hover:scale-[1.05] transition-transform duration-200"
              >
                <Icon className="w-[clamp(1.5rem,2vw,2rem)] h-[clamp(1.5rem,2vw,2rem)]" />
              </div>
            ))}
          ...
          {[
            ...
            <div key={idx} className="flex items-center gap-3">
              ...
              <div>
                ...
                <p
                  className={`text-sm lg:text-base xl:text-base font-semibold text-[#0A1F8F] ${
