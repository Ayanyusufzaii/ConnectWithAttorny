...
<div className="hidden lg:block max-w-[1440px] mx-auto 
  ...
  <div className="flex items-center gap-6 xl:gap-8 justify-evenly">
    ...
    <div className="flex flex-col justify-center 
      ...
      <h2 className="text-[#0A1F8F] text-[35px] xl:text-[45px] 2xl:text-[45px] font-semibold capitalize leading-tight mb-2">
    ...
    {eligibilityCards.slice(0, 4).map((card, index) => (
      ...
      >
        <span className={`font-[Quicksand] font-normal leading-none 
          ...
          ${index % 2 === 0 ? 'text-[#EDC14A]' : 'text-[#0A1F8F]'}`}>
          {card.number}
        </span>
        <p className="text-[#0A1F8F] font-medium tracking-[-0.32px] capitalize text-left
...
<div className="hidden md:flex lg:hidden max-w-[1200px] mx-auto flex-col items-center gap-6 px-4 py-2 md:gap-6 xl:gap-8">
  ...
  <div className="grid grid-cols-2 gap-8">
    {eligibilityCards.map((card, index) => {
      ...
      const numberColor = (index === 0 || index === 3) ? 'text-[#EDC14A]' : 'text-[#0A1F8F]';
      ...
      return (
        ...
        >
          ...
          <p className="text-[#0A1F8F] text-[14px] font-medium leading-[20px] tracking-[-0.32px] capitalize text-left">
            {card.text}
          </p>
        </article>
      );
