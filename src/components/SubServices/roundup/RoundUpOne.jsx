...
const RoundUpOne = () => {
  ...
  <h1
    className="text-white mb-4 drop-shadow-lg capitalize font-[Quicksand] font-bold text-center
      ...
      lg:text-[39px] lg:leading-[52px] lg:max-w-[723px]
  ...
  <h2
    className="text-white mb-6 drop-shadow font-[Quicksand] font-normal text-center
      ...
      lg:text-[16px] lg:leading-[27px] lg:max-w-[737px]
...
<section className="flex sm:hidden relative w-full min-h-[90vh] items-start overflow-hidden">
  ...
  />
  {/* Content */}
  <div className="relative z-20 flex flex-col items-center w-full px-4 text-center pt-[80px] capitalize">
    <h1
      className="text-[27px] leading-[36px] font-bold text-white mb-4 drop-shadow-lg font-[Quicksand]"
    >
