...
export default function Compensation() {
  ...
  <li>Costs of port removal or surgical revision</li>
  <li>Pain, suffering, and permanent internal injuries</li>
  <li>Time missed from work and reduced earning potential</li>
  <li>Emotional distress or wrongful death claims</li>
