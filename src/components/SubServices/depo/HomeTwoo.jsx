...
// const FloatingInput = ({ type, id, label, value, onChange }) => {
...
//         className="peer w-full border border-gray-300 rounded-lg px-4 pt-6 pb-2 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-[#E7E9F4] text-[#0A1F8F] font-medium"
...
//     setFormData({
//       ...formData,
//       [id.replace('-mobile', '')]: type === 'checkbox' ? checked : value,
//     });
//   };
...
//         <FloatingInput type="text" id="name" label="Full Name" value={formData.name} onChange={handleChange} />
//         <FloatingInput type="tel" id="phone" label="Phone Number" value={formData.phone} onChange={handleChange} />
//         <FloatingInput type="email" id="email" label="Email" value={formData.email} onChange={handleChange} />
//       </div>
...
//           style={{ fontFamily: 'Quicksand, sans-serif' }}
//         >
//           <option value="">Select Lawsuit Category</option>
...
//         <label className="block text-sm font-medium text-gray-700 mb-1" style={{ fontFamily: 'Quicksand, sans-serif' }}>
//           Verify you're human
//         </label>
...
//   I agree to the{' '}
//   <a href="/PrivacyPolicy" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">
//     Privacy Policy
//   </a>{' '}
//   and{' '}
//   <a href="/Disclaimer" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">
//     Disclaimer
//   </a>{' '}
...
//   className={`flex items-center justify-center font-semibold min-w-[180px] md:min-w-[320px] px-8 md:px-32 py-4 rounded-lg shadow transition text-base md:text-lg mx-auto block w-full md:w-auto ${
...
//       <FloatingInput type="text" id="name-mobile" label="Full Name" value={formData.name} onChange={handleChange} />
//       <FloatingInput type="tel" id="phone-mobile" label="Phone Number" value={formData.phone} onChange={handleChange} />
//       <FloatingInput type="email" id="email-mobile" label="Email" value={formData.email} onChange={handleChange} />
...
//   I agree to the <a href="/PrivacyPolicy" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a> and
//   <a href="/Disclaimer" className="text-blue-600 underline ml-1" target="_blank" rel="noopener noreferrer">Disclaimer</a> and give my express written consent to be contacted by affiliates and/or lawyers.
// </label>
...
//         type="submit"
//         disabled={!captchaValid || loading}
//         className={`flex items-center justify-center font-semibold w-full py-4 rounded-lg shadow transition text-base ${
//           captchaValid 
//             ? 'hover:bg-blue-700' 
//             : 'opacity-50 cursor-not-allowed'
//         }`}
...
//         </h2>
//         <div className="hidden md:block w-full mb-2 mt-16">
//           <DesktopForm />
//         </div>
//         <div className="block md:hidden w-full mb-2 mt-16">
//           <MobileForm />
//         </div>
//       </div>
//     </section>
