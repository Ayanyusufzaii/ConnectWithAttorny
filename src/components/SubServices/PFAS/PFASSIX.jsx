...
export default function PFASSIX() {
  return (
    <section
      ...
      <div className="relative max-w-[1200px] 2xl:max-w-[1400px] w-full mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12">
        ...
        <div className="block md:hidden w-full pt-6 px-4">
          ...
          <div className="w-full text-white pt-4">
            ...
            <ul className="list-disc pl-5 text-[14px] min-[350px]:text-[16px] min-[400px]:text-[17px] sm:text-[16px] font-normal leading-[28px] min-[400px]:leading-[30px] sm:leading-[32px] capitalize space-y-2">
