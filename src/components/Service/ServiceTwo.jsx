...
const ServiceTwo  = () => {
  return (
  <section className="bg-[#13247C] text-white py-12 px-4 sm:px-8 md:px-16 " style={{ fontFamily: 'Quicksand, sans-serif' }}>
      ...
      {features.map((item, idx) => (
        ...
        >
          <div className="flex justify-center mb-4 ">
            <img
              src={item.icon}
              alt="Feature Icon" aria-hidden="true"
              className="w-12 h-12 object-contain "
            />
          </div>

          <h3 className="text-lg font-quicksand font-semibold mb-2 text-[#0A1F8F]">{item.title}</h3>
